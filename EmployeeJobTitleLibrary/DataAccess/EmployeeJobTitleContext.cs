...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-GS7217LL;Database=EmployeeJobTitle;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Dbaccount>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__DBAccoun__349DA586178BB1EF");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04FF165B94D6E");
        ...
        {
            entity.HasKey(e => e.JobTitleId).HasName("PK__JobTitle__35382FC951E45AF9");
